...
\centering
\normalsize 
Befehle und Unterstützung zur Erstellung von Beispielformaten im Rahmen der standardisierten schriftlichen Reifeprüfung (SRP) in Mathematik, gemäß den Vorlagen des Bundesinstituts für Bildungsforschung, Innovation \& Entwicklung des österreichischen Schulwesens (bifie).  
...
%Für die Installation von \LaTeX~und müssen zuerst die folgenden Programme (in der angegebenen Reihenfolge!) installiert werden:
%\begin{enumerate}
...
Das \texttt{mathematik}-Paket ermöglicht auch die automatische Erstellung von Gruppen für Schularbeiten, durch Vertauschung der Antwortmöglichkeiten aller Typ1-Aufgaben. Dazu muss im Preamble (Bereich vor \texttt{\textbackslash begin\{document\}}) folgender Befehl eingefügt werden:\\ 
...
Das \texttt{mathematik}-Paket ermöglicht die Verwendung vorgefertigter Aufgabenformate, die bei der österreichischen, standardisierten Reifeprüfung Anwendung finden.
